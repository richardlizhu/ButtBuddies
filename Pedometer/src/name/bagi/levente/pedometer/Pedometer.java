...
public class Pedometer extends Activity {
	...
	private PopupWindow loginScreen;
	
	
	private void initiatePopupWindow() {
		try {
			LayoutInflater inflater = (LayoutInflater) Pedometer.this
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			View layout = inflater.inflate(R.layout.login,
					(ViewGroup) findViewById(R.id.popup_element));
			loginScreen = new PopupWindow(layout, popupWidth, popupHeight, true);

			loginScreen.showAtLocation(layout, Gravity.CENTER, 0, 210);
			EditText editText1 = (EditText) findViewById(R.id.editWeightResult);
	...
	private OnClickListener login_click_listener = new OnClickListener() {
	...
	private void initiatePopupWindow1() {
		try {
			...
			pwindo.showAtLocation(layout, Gravity.CENTER, 0, 210);
			...
			popupText.setText("Your average steps over last 7 days: 11256 \n 1 Day Ago: 15299 \n 2 Days Ago: 12965 \n 3 Days Ago: 12457 \n 4 Days Ago: 14236 \n 5 Days Ago: 11137 \n 6 Days Ago: 4875 \n 7 Days Ago: 7823 ");													
	...
	private void initiatePopupWindow2() {
		try {
			...
			View layout = inflater.inflate(R.layout.activity_two,
					(ViewGroup) findViewById(R.id.popup_element));
			pwindo2 = new PopupWindow(layout, popupWidth, popupHeight, true);

			pwindo2.showAtLocation(layout, Gravity.CENTER, 0, 210);
			
			Button btnClosePopup = (Button) layout.findViewById(R.id.btn_close_popup);
			TextView popupText=(TextView) pwindo2.getContentView().findViewById(R.id.txtView);
			popupText.setText("You currently have 4 challenges \n Group: Butt Buddies \t Rank: 3/6 \t Prize: $24.00 \n Group: Faffers \t Rank: 2/10 \t Prize: $30.00 \n Group: Chongers \t Rank: 6/11 \t Prize: $11.00 \n Group: Sawyers \t Rank: 3/3 \t Prize: $18.00");																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																								
	...
	private Person[] sortPeople()
	{
    	...
    	try {
	    	...
	    	while (json.length() > 0)
	    	{
	    	peopleList[counter] = gson.fromJson(json, Person.class);
	...
	private void initiatePopupWindow3() {
		try {
			...
			View layout = inflater.inflate(R.layout.activity_two,
					(ViewGroup) findViewById(R.id.popup_element));
			pwindo3 = new PopupWindow(layout, popupWidth, popupHeight, true);

			pwindo3.showAtLocation(layout, Gravity.CENTER, 0, 210);

			Button btnClosePopup = (Button) layout.findViewById(R.id.btn_close_popup);
			TextView popupText=(TextView) pwindo3.getContentView().findViewById(R.id.txtView);
			btnClosePopup.setOnClickListener(cancel_button_click_listener3);
			//Person[] peopleArray = sortPeople();
			//popupText.setText("Rank 1:" + peopleArray[0].getUser() + "\n Rank 2:" + peopleArray[1].getUser() + "\n Rank 3:" + peopleArray[2].getUser());
			popupText.setText("Rank 1: Alex Zhang : 25149 Steps \n Rank 2: Jamie Matthews : 22976 Steps \n Rank 3: Surabi Kondapaka : 17223 Steps \n Rank 4: Richard Zhu : 14476 Steps \n Rank 5: Sohum Dalal : 3543 Steps");
	...
	private OnClickListener cancel_button_click_listener3 = new OnClickListener() {
		public void onClick(View v) {
			pwindo3.dismiss();
		}
	};
